...
module.exports = {
    ...
    async execute(client, interaction) {
		...
		const suggestionChannel = interaction.member.guild.channels.cache.get(suggestion.channel);

        if(!suggestionChannel) return interaction.reply(`${suggestion.no_channel}`)
